...
#line 16 "mini_l.yy" // lalr1.cc:377
...
#line 83 "parser.tab.hh" // lalr1.cc:377
...
#line 160 "parser.tab.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const StmtStruct v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_IDENT_VAR (const std::string& v, const location_type& l);

    static inline
    symbol_type
    make_IDENT_NUM (const int& v, const location_type& l);
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 57: // dclr_loop
      case 58: // stmt_loop
        value.copy< StmtStruct > (other.value);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const StmtStruct v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    switch (yytype)
    {
      ...
      case 57: // dclr_loop
      case 58: // stmt_loop
        value.template destroy< StmtStruct > ();
        break;
  ...
  parser::symbol_type
  parser::make_IDENT_VAR (const std::string& v, const location_type& l)
  {
    return symbol_type (token::IDENT_VAR, v, l);
  }

  parser::symbol_type
  parser::make_IDENT_NUM (const int& v, const location_type& l)
  {
    return symbol_type (token::IDENT_NUM, v, l);
  }
